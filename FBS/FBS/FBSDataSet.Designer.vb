...
Namespace FBSDataSetTableAdapters
    ...
    Partial Public Class BookingTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Booking] WHERE (((@IsNull_BookingDate = 1 AND [BookingDate] IS NULL)"& _ 
                " OR ([BookingDate] = @Original_BookingDate)) AND ((@IsNull_BookingTime = 1 AND ["& _ 
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As FBSDataSet.BookingDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_BookingDate As Global.System.Nullable(Of Date), ByVal Original_BookingTime As String, ByVal Original_VisitDate As Global.System.Nullable(Of Date), ByVal Original_BookingCharges As Global.System.Nullable(Of Decimal), ByVal Original_BookingID As Integer) As Integer
            ...
            If (Original_VisitDate.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_VisitDate.Value,Date)
            Else
            ...
            If (Original_BookingCharges.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(7).Value = CType(Original_BookingCharges.Value,Decimal)
            Else
