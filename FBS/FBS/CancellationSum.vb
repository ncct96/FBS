...
Public Class CancellationSum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FBS.CancellationSum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCancellationSum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CancellationSum = New CancellationSum()
        rpt.Site = Me.Site
        Return rpt
    End Function
